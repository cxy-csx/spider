...
function sign(e, t) {
    var r = 1452
        ...
        , lr = (cr(s, u) + cr(1462, 1388) + cr(l, c))[cr(d, 1691)]("|");
    ...
    for (var dr = 0; ;) {
        switch (lr[dr++]) {
                            ...
                            case "5":
                                for (; f < e[n(1188, he)];)
                                    a = e[n(me, ve) + n(ye, be)](f++),
                                        ...
                                        d = _r[n(Ce, 1341)]((15 & s) << 2, _r[n(Re, Pe)](u, 6)),
                                        p = _r[n(Ne, Me)](u, 63),
                                        _r[n(je, De)](isNaN, s) ? d = p = 64 : _r[n(Fe, 1297)](isNaN, u) && (p = 64),
                                        i = _r[n(Be, Ue)](_r[n(He, 1157)](_r[n(We, $e)](i, gr[n(Ve, Ge)](l)), gr[n(ze, 1043)](c)) + gr[n(qe, 1043)](d), gr[n(874, Ge)](p));
                                continue
                        }
                        break
                    }
            ...
            case "7":
                pr = "test";
                ur[cr(1587, G)]((0,
                    esm_typeof.Z)(vr), ur[cr(z, 1531)]) && vr && vr[cr(q, Y) + "or"] && vr[cr(1417, Z) + "or"][cr(K, 1250) + "nt"] && vr[cr(X, J)] && (pr = ur[cr(Y, Q)]);
                continue;
            case "8":
                var yr = "1678262291974";
                continue;
            case "9":
                return {
                    "X-s": ur[cr(re, ne)](mr, ur[cr(oe, ie)](CryPtoJS.MD5, [yr, pr, e, hr ? JSON[cr(ae, se) + "fy"](t) : ""][cr(ue, le)](""))),
                    "X-t": yr
                }
        }
        break
...
!function (e, t) {
    ...
    for (; ;)
        try {
            if (362698 === parseInt(S(144, r)) / 1 + -parseInt(S(n, -o)) / 2 * (parseInt(S(-i, -a)) / 3) + -parseInt(S(s, -u)) / 4 * (-parseInt(S(-81, -l)) / 5) + -parseInt(S(-160, c)) / 6 * (parseInt(S(-d, -p)) / 7) + parseInt(S(-f, _)) / 8 * (-parseInt(S(-g, -h)) / 9) + -parseInt(S(m, v)) / 10 + parseInt(S(y, b)) / 11)
                break;
            T.push(T.shift())
        } catch (E) {
            T.push(T.shift())
